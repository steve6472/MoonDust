 ...
 * Project: MoonDust <br>
 */
public record TextBlueprint(Text text, PositionBlueprint position) implements Blueprint
{
    ...
    {
        return List.of(new MDText(text.withMutableParts(), (Position) position.createComponents().getFirst()));
    }
}
