 ...
 * Project: MoonDust <br>
 */
public record ButtonBlueprint(Key pressCall, Key pressScript, String label, boolean labelShadow) implements Blueprint
{
    ...
    public static final Codec<ButtonBlueprint> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        Key.CODEC.optionalFieldOf("press_script", NO_CALL).forGetter(ButtonBlueprint::pressScript),
